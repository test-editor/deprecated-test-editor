...
/**
 * 
 * Plug-In extension of the TestServerService. Plug-In Provider must implement
 * this interface and not the TestServerService. The interface TestServerService
 * is for client usage only.
 *
 */
public interface TestServerServicePlugIn extends TestServerService {
