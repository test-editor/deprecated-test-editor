 ...
 * 
 */
public class RenameTestScenarioWizardPage extends AbstractRenameTestStructureWizardPage {
	@Inject
	...
	public String getDescriptionValue() {
		return translationService.translate("%rename.wizard.whitemsg.scenario");
	}
