 ...
 */
public class MoveScenarioWizardPage extends AbstractNewTestStructureWizardPage {
	@Inject
	private TestEditorTranslationService translationService;

	@Override
	public String getTitleValue() {
		return translationService.translate("%popupmenu.label.move.test.scenario");
	}
	...
	public String getDescriptionValue() {
		return translationService.translate("%move.wizard.whitemsg.scenario", getSelectedTestStructure().getName(),
