...
/**
 * wizard for renaming of test-suites.
 * 
 * @author llipinski
 * 
 */
public class RenameTestSuiteWizardPage extends AbstractRenameTestStructureWizardPage {
	...
	public String getDescriptionValue() {
		return translationService.translate("%rename.wizard.whitemsg.suite");
	}
