...
public class TestStructureTree {
	 ...
	 *            as SWT-Style
	 */
	public void createUI(Composite parent, TestStructureTreeInputService treeInputService, int style) {
	 ...
	 */
	private void initializeInternalsToTreeViewer(TestStructureTreeInputService treeInputService) {
	 ...
	 *            Root-Teststructures
	 */
	public void createUI(Composite parent, TestStructureTreeInputService treeInputService) {
