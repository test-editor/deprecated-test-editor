 ...
 * 
 */
public class AdminManualHandler {

	@Inject
	private FileLocatorService fileLocatorService;

	private static final Logger LOGGER = Logger.getLogger(AdminManualHandler.class);
	...
	public void execute(@Named(IServiceConstants.ACTIVE_SHELL) Shell shell) {
		...
		try {
			...
			Program.launch(absolutPathToBundle + File.separator + "TestEditorAdminManualDe.pdf");
		} catch (IOException e) {
