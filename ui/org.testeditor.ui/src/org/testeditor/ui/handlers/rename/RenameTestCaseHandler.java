...
import org.testeditor.ui.wizardpages.RenameTestCaseWizardPage;
 ...
 * 
 */
public class RenameTestCaseHandler extends AbstractRenameHandler {
	@Inject
	private IEclipseContext context;

	@Override
	protected AbstractRenameTestStructureWizardPage getRenameTestStructureWizardPage(TestStructure selectedTS) {
		RenameTestCaseWizardPage testCaseWizardPage = ContextInjectionFactory.make(RenameTestCaseWizardPage.class,
				context);
