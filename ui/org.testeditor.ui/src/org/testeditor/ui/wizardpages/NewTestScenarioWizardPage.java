...
/**
 * 
 * this class provides the special parts of the NewTestScenarioPage an extends
 * the {@link AbstractNewTestStructureWizardPage}.
 * 
 */
public class NewTestScenarioWizardPage extends AbstractNewTestStructureWizardPage {
	...
	public String getTitleValue() {
		return translationService.translate("%popupmenu.label.new.test.scenario");
	}
	...
	public String getDescriptionValue() {
		return translationService.translate("%new.wizard.whitemsg.scenario");
	}
