...
/**
 * 
 * IntegrationTests for NewCaseHandler.
 * 
 */
public class NewCaseHandlerTest {
	...
	public void testCanExecuteFromMenu() throws Exception {
		...
		newCaseHandler = ContextInjectionFactory.make(NewCaseHandler.class, context);
		assertTrue("Expecting can execute on workspace with projects.", newCaseHandler.canExecute(context, "true"));
	}
