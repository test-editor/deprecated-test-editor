...
public class URLFieldDeclaration implements FieldMappingExtension {
	...
	public String getTranslatedLabel(TranslationService translationService) {
		return translationService.translate("%svnteamshare.url.label", "platform:/plugin/org.testeditor.teamshare.git");
	}
	...
	public String getTranslatedToolTip(TranslationService translationService) {
		return translationService.translate("%svnteamshare.url.tooltip",
				"platform:/plugin/org.testeditor.teamshare.git");
	}

	@Override
	public void updatePlugInConfig(Object bean, String newValue) {
		((GitTeamShareConfig) bean).setUrl(newValue);
	}

	@Override
	public String getStringValue(Object bean) {
		return ((GitTeamShareConfig) bean).getUrl();
	}
